...
func WithSkipper(skipper middleware.Skipper) Option { _ = "STUB: not implemented"; return *new(Option) }
...
func WithOnError(f OnErrorFn) Option { _ = "STUB: not implemented"; return *new(Option) }
