...
// read and the error.
func (w *BodyWrapper) Read(b []byte) (int, error) { _ = "STUB: not implemented"; return 0, nil }

func (w *BodyWrapper) updateReadData(n int64, err error) { _ = "STUB: not implemented"; return }

// Close closes the io.ReadCloser.
func (w *BodyWrapper) Close() error { _ = "STUB: not implemented"; return nil }

// BytesRead returns the number of bytes read up to this point.
func (w *BodyWrapper) BytesRead() int64 { _ = "STUB: not implemented"; return 0 }

// Error returns the last error.
func (w *BodyWrapper) Error() error { _ = "STUB: not implemented"; return nil }
